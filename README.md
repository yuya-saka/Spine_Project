# 頸椎骨折検出プロジェクト (Spine Project)


## 📋 プロジェクト概要

このプロジェクトは、椎体(頸椎)骨折検出の深層学習システムです。PyTorch、Hydraを使用した医療AI研究プロジェクトで、基本的な予測から高度な解釈性分析まで行う

- **対象**: 各椎体3DCTデータ(C1~C7)
- **予測対象**: 骨折領域
- **アーキテクチャ**: 3DCTデータからの検出タスク
- **技術スタック**: PyTorch
- **データ形式**: DICOM -> NIFTI ->.npy
## 📖 医療AI研究での利用
...
#### **重要な指示** 
    - Claude Codeへの指示:(現在作業しているフォルダ**@prototype/**)
...
## 補足
- sample36には、骨折区間が二つあり、936~965, 1030~1086にある。